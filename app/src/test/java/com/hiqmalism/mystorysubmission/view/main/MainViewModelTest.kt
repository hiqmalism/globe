...
import com.hiqmalism.mystorysubmission.DataDummy
import com.hiqmalism.mystorysubmission.MainDispatcherRule
...
import com.hiqmalism.mystorysubmission.getOrAwaitValue
...
class MainViewModelTest{
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        `when`(userRepository.getStories()).thenReturn(expectedStory)
